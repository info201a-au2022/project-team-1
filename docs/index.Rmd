...
![](docs/photos/DataSetTableP2.png)
...
library(knitr)
library(dplyr)
summary_table <- read.csv(file = "..data//tiktok_and_spotify_popular.csv")
...
1)
```{r echo = FALSE}
source("../source/tt_and_spotify.R", local = TRUE)
...
3)
```{r echo = FALSE}
source("../source/pie_tt_spotify_22.R", local = TRUE)
